          ...
          {activeMode === 'emergency' && (
            ...
            >
              <div className="mb-8 text-center">
                ...
                <p className={`text-xl ${highContrast ? 'text-gray-600' : 'text-gray-700'} max-w-3xl mx-auto`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {emergencyOptions.map((option, index) => (
                  ...
                  >
                    ...
                    <p className={`${highContrast ? 'text-gray-600' : 'text-gray-700'} mb-4`}>
                      {option.subtitle}
                    </p>
                    ...
                    <div className="flex items-center justify-between text-sm mb-4">
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className={highContrast ? 'text-gray-600' : 'text-gray-700'}>
                            {option.available}
                          </span>
                        </div>
                        <div className="flex items-center space-x-1">
              ...
              <div className={`mt-8 p-6 ${highContrast ? 'bg-gray-900 border-gray-700' : 'bg-blue-50'} rounded-2xl border`}>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className={`${highContrast ? 'text-gray-600' : 'text-gray-700'} mb-3`}>
                ...
                {supportResources.map((resource, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span className={`text-xs ${highContrast ? 'text-gray-600' : 'text-gray-700'}`}>
            ...
            >
              ...
              >
                <div className="text-center">
                  ...
                  <p className={`${highContrast ? 'text-gray-600' : 'text-gray-700'} mb-6`}>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 ${highContrast ? 'text-gray-600 hover:text-white' : 'text-gray-700 hover:text-gray-900'} transition-colors`}
                  >
                    Cancel
                  </button>
                </div>
