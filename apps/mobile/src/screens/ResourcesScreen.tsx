...
import OfflineService, { CrisisTip, EmergencyContact } from '../services/OfflineService';
...
interface Resource {
  ...
  category: 'crisis' | 'coping' | 'therapy' | 'emergency' | 'education';
  url?: string;
  phone?: string;
  content?: string;
}
...
export default function ResourcesScreen() {
  ...
  const [crisisTips, setCrisisTips] = useState<CrisisTip[]>([]);
  ...
  const renderResource = (resource: Resource) => {
    ...
    return (
      <TouchableOpacity
        key={resource.id}
        style={[styles.resourceCard, getUrgencyStyle()]}
  ...
  const renderQuickAccess = () => (
    <View style={styles.quickAccessSection}>
      ...
      <View style={styles.quickAccessGrid}>
        ...
        <TouchableOpacity 
          style={styles.quickAccessButton}
          onPress={() => handleResourcePress(mockResources[2])} // Grounding technique
        >
          <Text style={styles.quickAccessIcon}>🧘</Text>
        ...
        <TouchableOpacity 
          style={styles.quickAccessButton}
          onPress={() => handleResourcePress(mockResources[3])} // Breathing exercise
        >
          <Text style={styles.quickAccessIcon}>💨</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.resourcesList} showsVerticalScrollIndicator={false}>
        ...
        {selectedCategory === 'all' || selectedCategory === 'coping' ? (
          <View style={styles.offlineSection}>
            <Text style={styles.sectionTitle}>💡 Offline Coping Tips</Text>
            {crisisTips.slice(0, 3).map((tip) => (
