...
export default function ChatScreen() {
    ...
    const handleEmergency = () => {
        Alert.alert('Emergency Help', 'Do you need immediate emergency assistance?', [
            {
                text: 'Yes, call 911',
                onPress: () => {
    ...
    const renderMessage = (message) => {
        ...
        {!isUser && !isSystem && (<Text style={styles.senderName}>
    ...
    return (<KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      ...
      <View style={styles.inputContainer}>
        <TextInput style={styles.textInput} value={inputText} onChangeText={setInputText} placeholder="Type your message here..." placeholderTextColor="#9CA3AF" multiline maxLength={1000}/>
...
//# sourceMappingURL=ChatScreen.jsx.map