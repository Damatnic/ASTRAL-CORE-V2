...
import CrisisService, { CrisisSession } from '../services/CrisisService';
...
export default function VolunteerScreen() {
  ...
  const handleJoinSession = async (sessionId: string) => {
    try {
      Alert.alert(
        'Join Crisis Session',
        'Are you ready to join this crisis session?',
        [
          {
            text: 'Cancel',
            style: 'cancel',
  ...
  const handleEscalateSession = async (sessionId: string) => {
    Alert.alert(
      'Escalate to Emergency',
      'This will immediately contact emergency services. Continue?',
      [
        {
          text: 'Cancel',
          style: 'cancel',
  ...
  const renderStatsCard = () => (
    <View style={styles.statsCard}>
      ...
      {volunteerStats.burnoutRisk !== 'low' && (
        <Text style={styles.burnoutWarning}>
  ...
  const renderActiveSession = (session: ActiveSession) => (
    <View key={session.id} style={styles.sessionCard}>
      ...
      <View style={styles.sessionDetails}>
        ...
        {session.anonymous && (
          <Text style={styles.anonymousTag}>🔒 Anonymous User</Text>
        )}
      </View>
      ...
      <View style={styles.sessionActions}>
        ...
        <TouchableOpacity
          ...
          onPress={() => handleEscalateSession(session.id)}
        >
