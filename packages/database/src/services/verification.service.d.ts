 ...
 */
export declare function getPendingVerifications(limit?: number): Promise<User[]>;
/**
 * Gets verified professionals by type
 */
export declare function getVerifiedProfessionals(professionalType?: string, specializations?: string[]): Promise<User[]>;
/**
